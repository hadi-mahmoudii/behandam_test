...
class FadeOnScroll extends StatefulWidget {
  ...
  FadeOnScroll({Key? key, required this.scrollController, required this.child, this.zeroOpacityOffset = 0, this.fullOpacityOffset = 0});
  ...
  double _calculateOpacity() {
    if (widget.fullOpacityOffset == widget.zeroOpacityOffset)
      ...
      if (_offset! <= widget.fullOpacityOffset) {
        ...
        return 1 - (_offset! - widget.fullOpacityOffset) / (widget.zeroOpacityOffset - widget.fullOpacityOffset);
      }
    }
  }
